...
def main(spark, input_path, output_path):
    # data extraction from defined sources
    ...
    print('Integrity Check: {0}'.format(checker.integrity_checker(
        immigration_fact, dim_demographics, dim_airports, dim_temperature)))
